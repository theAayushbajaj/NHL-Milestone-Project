...
def plot_calibration_curve(model, features, target, val, train, model_reg_filename, tags, experiment
    ...
    confusion_matrix_path = plot_confusion_matrix(y_val, y_pred)
    classification_report_path = plot_classification_report(y_val, y_pred)
    ...
    plt.savefig(complete_figure_filename)
    plt.close()  # Close the figure to free up memory

    # Log the entire figure to Comet
    experiment.log_image(complete_figure_filename)
