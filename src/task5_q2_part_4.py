...
print(results)
results.to_csv('adv_prob_q2_tune.csv')
...
plt.savefig("adv_prob_q2_tune_confusion_matrix.png")
plt.show()
...
target = 'is_goal'
model_filename = 'xgboost_model_q2_tune.json'
...
experiment.log_table("adv_prob_q2_tune_confusion_matrix.png", cfn_mat.tolist())
...
experiment.log_image("adv_prob_q2_tune_confusion_matrix.png", "Confusion_matrix")
experiment.log_image("dataset_balance.png", "Dataset unbalanced")
experiment.log_image("xgboost_q2_tune_diagrams.png", "Diagrams")

experiment.log_confusion_matrix(y_val, y_pred,
    title="Confusion Matrix: Evaluation",
    file_name='xgboost_q2_tune_diagrams.png')
